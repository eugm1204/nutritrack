...
/// Sheet de pesquisa/adicionar alimentos. Mantém-se aberto depois de adicionar
/// para permitir adicionar vários itens; o utilizador fecha manualmente.
class AddItemSheet extends ConsumerStatefulWidget {
  final void Function(MealItem item) onAdd;
...
class _AddItemSheetState extends ConsumerState<AddItemSheet> {
  ...
  void _addManual() {
    ...
    _notify(MealItem(name: name, calories: calories, confirmed: true));
  }
